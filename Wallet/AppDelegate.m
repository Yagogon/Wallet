...
self.window = [[UIWindow alloc] initWithFrame:[[UIScreen mainScreen] bounds]];
    ...
    AGTWallet *wallet = [[AGTWallet alloc] initWithAmount:20 currency:@"USD"];
   
    [wallet plus:[AGTMoney euroWitAmount:40]];
    [wallet plus:[AGTMoney euroWitAmount:140]];
    [wallet plus:[AGTMoney euroWitAmount:440]];
    
    [wallet plus:[AGTMoney dollarWithAmount:20]];
    [wallet plus:[AGTMoney dollarWithAmount:10]];
    [wallet plus:[AGTMoney dollarWithAmount:90]];
